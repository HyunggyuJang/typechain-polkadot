...
```bash
npm i -D @arthswap/typechain-polkadot
```
...
```bash
npx @arthswap/typechain-polkadot --input path/to/abis --output path/to/output
```
...
```typescript
import {Typechain} from '@arthswap/typechain-polkadot/src/types/typechain';
...
```typescript
import {TypechainPlugin} from '@arthswap/typechain-polkadot/src/types/interfaces';
...
```bash
npx @arthswap/typechain-polkadot --input path/to/abis --output path/to/output --plugins ./plugins-directory
```
